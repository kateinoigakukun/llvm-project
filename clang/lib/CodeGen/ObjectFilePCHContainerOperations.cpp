...
public:
  ...
  void HandleTranslationUnit(ASTContext &Ctx) override {
    ...
    if (Triple.isOSBinFormatWasm()) {
      ...
      llvm::NamedMDNode *MD = M->getOrInsertNamedMetadata("wasm.custom_sections");
      llvm::Metadata *Ops[2] = {llvm::MDString::get(*VMContext, "__clangast"),
                                llvm::MDString::get(*VMContext, StringRef(SerializedAST.data(), Size))};
